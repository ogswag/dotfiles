;;; yoshi-theme.el --- Theme named after my cat -*- no-byte-compile: t; lexical-binding: t; -*-

;; Copyright (C) 2012, 2013, 2014, 2015, 2019, 2021  Tom Willemsen

;; Author: Tom Willemse <tom@ryuslash.org>
;; Keywords: faces
;; Package-Version: 20230801.1741
;; Package-Revision: 61e4250ae327
...
(let ((yoshi-0 "#222424")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((t (:background ,yoshi-2 :foreground ,yoshi-6 :box (:color ,yoshi-2 :line-width 1 :style nil)))))
   `(mode-line-buffer-id ((t (:background ,brred :foreground ,yoshi-1 :box (:color ,brred :line-width 1 :style nil)))))
   `(mode-line-highlight ((t (:background ,yoshi-3 :foreground ,yoshi-6 :box (:color ,yoshi-3 :line-width 1 :style nil)))))
   `(mode-line-inactive ((t (:background ,yoshi-1 :foreground ,yoshi-5 :box (:color ,yoshi-1 :line-width 1 :style nil)))))

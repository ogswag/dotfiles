...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-inactive ((,class (:box (:line-width -1 :style released-button) :background ,alum-4 :foreground ,alum-6))))
   ...
   `(font-lock-comment-face ((,class (:foreground "#CCFF73" :background "#B8B8B8"))))
   ...
   `(font-lock-doc-face ((,class (:foreground ,orange-4))))
   ...
   `(ansi-color-bright-magenta ((,class (:background ,plum-1 :foreground ,plum-1))))

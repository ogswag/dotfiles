...
;; Author: ported by Claude from farigab/nocturne-and-daylight flexoki-light.json
;; SPDX-License-Identifier: MIT

;;; Commentary:

;; A single-file Emacs port of the "Flexoki Light" theme distributed as a
;; VSCode/TextMate JSON in farigab/nocturne-and-daylight.  The Flexoki color
...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(linum			((,class (:background ,bg :foreground ,muted))))

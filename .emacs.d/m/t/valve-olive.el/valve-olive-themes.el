...
Each element is suitable as an argument to `custom-theme-set-faces'."
  (let* ((p (valve-olive-themes-palette variant))
    ...
    (list
     ...
     `(tab-bar-tab          ((t (:foreground ,gold :background ,bg :weight bold
                                             :box (:line-width 2 :color ,bg)))))
     `(tab-bar-tab-inactive ((t (:foreground ,fg-dim :background ,bg-dark
     ...
     `(speedbar-directory-face ((t (:foreground ,teal :weight bold))))
     `(speedbar-file-face      ((t (:foreground ,fg))))
     `(speedbar-selected-face  ((t (:foreground ,accent :underline t))))
     `(speedbar-highlight-face ((t (:background ,bg-sel))))
     `(speedbar-button-face    ((t (:foreground ,gutter))))
     `(speedbar-tag-face       ((t (:foreground ,green))))
     `(speedbar-separator-face ((t (:foreground ,black :background ,accent))))

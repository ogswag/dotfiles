...
function in a let."
  ...
  (custom-theme-set-faces
   ...
   `(fill-column-indicator ((t :inherit border)))
   ...
   `(font-latex-math-face ((t (:foreground ,latex-math))))
   `(font-latex-script-char-face ((t (:foreground ,warning))))
   `(font-latex-bold-face ((t (:foreground ,string :weight bold))))
   `(font-latex-italic-face ((t (:foreground ,string :slant italic))))
   `(font-latex-match-reference-keywords ((t (:foreground ,fg))))
   `(font-latex-match-variable-keywords ((t (:foreground ,fg))))
   `(font-latex-sedate-face ((t (:foreground ,latex-math))))
   `(font-latex-string-face ((t (:foreground ,string))))
   `(font-latex-sectioning-5-face ((t (:foreground ,latex-math :inherit variable-pitch :weight bold))))
   `(TeX-fold-folded-face ((t (:foreground ,latex-folded))))
   `(TeX-fold-unfolded-face ((t (:foreground nil :background ,latex-unfolded))))
   `(font-lock-builtin-face ((t (:foreground ,fg-bright))))
   ...
   `(font-lock-function-name-face ((t (:foreground ,fg-bright :weight bold))))
   `(font-lock-keyword-face ((t (:foreground ,fg-bright :inherit bold))))

...
(let ((class '((class color) (min-colors 89)))
      ...
      (bg3 "#d3d7cf")
      (bg4 "#babdb6")
      (builtin "#75507b")   ;; Sky Blue Shadow
      (keyword "#3465a4")   ;; Chameleon Shadow
      (const   "#75507b")   ;; Plum Shadow
      (comment "#3B7900")   ;; Chameleon Shadow
      (func    "#a40000")   ;; Scarlet Red Shadow
      (str     "#c17d11")   ;; Chocolate Shadow
      (type    "#3465a4")   ;; Sky Blue Shadow
      (var     "#ce5c00")   ;; Orange Shadow
      (cursor  "#294B83")
      (warning "#cc0000")   ;; Scarlet Red
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-function-name-face ((,class (:foreground ,func :box (:line-width -1)))))
   ...
   `(mode-line ((,class (:box (:line-width 1 :color nil) :foreground ,fg2 :background ,bg3))))
   `(mode-line-inactive ((,class (:box (:line-width 1 :color nil :style pressed-button) :foreground ,fg3 :background ,bg4 :weight normal))))
   ;; `(mode-line-buffer-id ((,class (:in))))
